...
_valid_states = frozenset({
    ...
    "HOLDING", "FOLLOWING", "GRABBING", "ACTING",
})

# states that indicate the robot is busy with a task
_busy_states = frozenset({"FETCHING", "DELIVERING", "SEARCHING", "HOLDING", "FOLLOWING", "GRABBING"})
...
_transitions: Dict[str, FrozenSet[str]] = {
    ...
    "ACTING": frozenset({
        "IDLE", "SCANNING", "EXPRESSING", "ROAMING"
    }),
}
